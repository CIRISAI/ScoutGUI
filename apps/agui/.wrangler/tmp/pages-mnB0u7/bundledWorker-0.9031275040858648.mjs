...
var F = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? re(oe(e)) : {}, ie(t || !e || !e.__esModule ? U(r, "default", { value: e, enumerable: true }) : r, e)), "F");
var y;
var u = E(() => {
  y = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let o = globalThis[me], s = /* @__PURE__ */ __name(async () => {
          let c = await e.json();
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.9031275040858648.mjs.map
