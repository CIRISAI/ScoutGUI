...
const nextConfig = {
  ...
  env: {
    NEXT_PUBLIC_SCOUT_API_URL: process.env.NEXT_PUBLIC_SCOUT_API_URL || 'https://scoutapilb.ciris.ai/api/scout-remote-test-dahrb9',
    NEXT_PUBLIC_API_BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || 'https://scoutapilb.ciris.ai/api/scout-remote-test-dahrb9',
  },
